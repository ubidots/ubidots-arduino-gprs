...
#define VARIABLE_LABEL_ONE "Your_variable_name_here" // Assign the variable label 
#define VARIABLE_LABEL_TWO "Your_variable_name_here" // Assign the variable label 
#define VARIABLE_LABEL_THREE "Your_variable_name_here" // Assign the variable label 
